...
<section className="relative pb-10 overflow-hidden backdrop">
  ...
  <div className="relative z-10 container px-4 mx-auto">
    <div className="max-w-4xl pt-20">
      ...
      <h2 className="mt-8 mb-8 lg:text-7xl md:text-4xl sm:text-4xl xsm:text-4xl text-white font-bold" data-config-id="header">Compare Multiple Medicare Insurance Quotes</h2>
...
<button className="px-6 py-4 mb-3 m-2 text-md font-bold bg-blue-400 hover:bg-blue-600 hover:shadow-lg text-white rounded transition duration-200 zipSubmit text-center" type="submit">Start Your No Obligation Free Quote</button>
